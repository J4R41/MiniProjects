...
function test()
{
	...
	main();
	type_sections();
	document.getElementById('text_into_sn').value = '.........XXXDDDDDD';
	document.getElementById('s_n').value = 5;
	document.getElementById('colorid').value = 'red';
...
function main()
{
	...
	document.getElementById('sectionst').value = 'Changed';
}
...
function exprt()
{
	let widthbg = 7 * maxx + 5;
	document.getElementById('datatxt').innerHTML = '<div style="background-color:black; color:#8800ff; font-family: monospace; width: ' + widthbg + 'px;">' + Data.map(e => e.join('')).join('<br>') + '<div>';
}